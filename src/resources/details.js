...
function createCommentArticle(comment) {
  ...
  appendChild(article, p);
  appendChild(article, commentFooter);
  return article;
}
...
async function initializePage() {
  ...
  if (resource){
    ...
    console.error('Error in initializing page: ', error);
    resourceTitle.textContent = "Error in loading resource.";
  }
}
